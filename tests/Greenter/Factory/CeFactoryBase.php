...
class CeFactoryBase extends TestCase
{
    ...
    {
        $sender  = $this->getSender(get_class($document), SunatEndpoints::RETENCION_BETA);
    ...
    protected function getXmlSigned(DocumentInterface $document): string
    {
        $builder = new $this->builders[get_class($document)]([
            'cache'            => false,
    ...
    protected function getRetention(): Retention
    {
        $client = new Client();
        $client->setTipoDoc('6')
    ...
    protected function getPerception(): Perception
    {
        $client = new Client();
        $client->setTipoDoc('6')
            ->setNumDoc('20000000001')
    ...
    protected function getReversion(): Reversion
    {
